...
export default function Error({
  ...
  return (
    <main className="p-6">
      <div className="mx-auto max-w-lg rounded-lg border border-rojo-tierra/30 bg-white p-6 text-center">
        <h1 className="mb-2 font-serif text-2xl text-rojo-tierra">Algo salió mal</h1>
        ...
        <button
          onClick={() => retry()}
          className="rounded bg-pasto px-6 py-3 font-medium text-white"
        >
          Intentar de nuevo
        </button>
      </div>
