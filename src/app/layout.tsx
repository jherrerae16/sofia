...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  // El menú es de adentro. Sin sesión no se pinta: ofrecer destinos a quien no
  // ha entrado es ofrecer puertas cerradas, y el nombre de la finca es un dato
  // que no tiene por qué leer cualquiera que abra la dirección.
  //
  // `auth()` puede fallar sin que nadie haya hecho nada mal -- una cookie
  // firmada con otro AUTH_SECRET al cambiar de entorno, por ejemplo --, y eso
